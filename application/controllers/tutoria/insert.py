...
class Insert:
    ...
    def POST(self):
        ...
        # call model insert_tutoria and try to insert new data
        config.model.insert_tutoria(
            form['alumno'],form['tutor'],form['carrera'],form['grupo'],form['area_tutoria'],form['nombre_responsable'],form['acciones'],form['resolucion'],form['fecha'],
        )
